            ...
            <ul>
              {depositHistory.map((deposit) => (
                <li key={deposit.id}>
                  ...
                  <button onClick={() => handleDelete(deposit.id, 'deposit')}>Delete</button>
                </li>
              ))}
            </ul>
            <p>Total Deposit Amount: {totalDepositAmount}</p>

            <h2>Withdrawal History</h2>
            <p>Total Withdrawal Amount: {totalWithdrawalAmount}</p>
